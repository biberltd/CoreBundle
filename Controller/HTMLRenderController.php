...
class HTMLRenderController extends  CoreController{
    ...
    public function renderBasicAjaxInput($inputDetails = array()){
        ...
        return $this->templating->render('BiberLtdCoreBundle:'.$vars['field']['settings']['theme'].'/Form:field.input.upload_ajax_simple.html.smarty', $vars);
    }
    /**
    ...
    public function renderCheckedMultiSelect($inputDetails = array()){
        ...
        return $this->templating->render('BiberLtdCoreBundle:'.$inputDetails['settings']['theme'].'/Form:field.checked_multiselect.html.smarty', $vars);
    }
    /**
    ...
    public function renderDropDown($inputDetails = array()){
        ...
        return $this->templating->render('BiberLtdCoreBundle:'.$inputDetails['settings']['theme'].'/Form:field.dropdown.html.smarty', $vars);
    }
    /**
    ...
    public function renderInput($inputDetails = array()){
        ...
        return $this->templating->render('BiberLtdCoreBundle:'.$inputDetails['settings']['theme'].'/Form:field.input.html.smarty', $vars);
    }
    /**
    ...
    public function renderLocationPicker($inputDetails = array()){
        ...
        return $this->templating->render('BiberLtdCoreBundle:'.$vars['field']['settings']['theme'].'/Form:field.locationpicker.html.smarty', $vars);
    }
    /**
    ...
    public function renderSingleImageInput($inputDetails = array()){
        ...
        return $this->templating->render('BiberLtdCoreBundle:'.$vars['field']['settings']['theme'].'/Form:field.input.upload_preview.html.smarty', $vars);
    }
    /**
     * @name 			renderTagInput()
    ...
    public function renderTextArea($inputDetails = array()){
        ...
        return $this->templating->render('BiberLtdCoreBundle:'.$vars['field']['settings']['theme'].'/Form:field.textarea.html.smarty', $vars);
    }
    /**
